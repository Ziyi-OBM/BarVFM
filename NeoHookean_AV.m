...
isVirtualStrain=false;
   [deformGrad,~,XYZcg]=deformationGrad(Node,Displacement,Elements,isVirtualStrain);
...
isVirtualStrain=true;
[~,virStrainField,XYZcg]=deformationGrad(Node,virDisplacement,Elements,isVirtualStrain);
% for i=1:numEle
%     elemNode=Node(Elements(i,:),:);
...
disp(['Plugging in parameters C1 = ',num2str(C1),',  K = ',num2str(K)])
disp(['Equation 1 the result is ',num2str(LHS1),'=',num2str(RHS1)])
disp(['Equation 2 the result is ',num2str(LHS2),'=',num2str(RHS2)])
